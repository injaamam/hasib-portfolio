export const higherStudyUSA = {
  sections: [
    {
      title: "1. My Profile & Visa Interview",
      subsections: [
        {
          title: "Profile",
          content: [
            ...
            "Interview appointment: June 18, 2023, 10:15 AM (Rescheduled twice from July 30, 2023, 10:30 AM)",
        ...
        },
        {
          ...
          content: [
            "Applied to a total of 10 universities, including 7 in the USA for a Ph.D. program and 3 in Canada for an M.Sc. program. Received acceptance letters from 6 universities and rejections from 4.",
            "USA:",
    ...
    {
      title: "3. Suggestions & Guidelines",
      subsections: [
        {
          title: "Overview",
          content: [
    ...
    {
      title: "4. Detailed Discussion and Roadmap",
      subsections: [
        {
          ...
          content: [
            ...
            "Learn Matlab, Python, Machine Learning, and Canva. I highly recommend exploring opportunities in the field of Machine Learning as it is considered the future of technology.",
            "Curating your CV, furnishing your LinkedIn Profile, opening a Twitter account, and building your Portfolio. Start building your Academic CV as early as possible, even if it may seem challenging at first. With time and effort, you will gradually improve and create a strong CV.",
            "Additionally, I cannot emphasize enough the importance of having a well-curated LinkedIn profile. Utilize this platform to showcase your academic and career-related achievements, and make meaningful connections.",
            ...
            "Additionally, you have the option to create a portfolio. Trust me, it can help you stand out, though it's not mandatory. For free and user-friendly website hosting, you have two options: Google Sites and GitHub. Google Sites is easier to set up but has limited capabilities. On the other hand, GitHub requires HTML coding and is slightly more challenging, but you can find attractive templates online. If you want a more professional look, you can purchase a domain. However, please note that none of these options are mandatory.",
        ...
        },
        {
          ...
          content: [
            ...
            "Now get your necessary papers sorted as soon as possible. These are: NID, Passport; Certificates (S.S.C., H.S.C.); B.Sc. Certificates and Transcripts; Other necessary certificates from the university; Sealed certificate and transcripts (at least 2 copies).",
            ...
            "Book your GRE, IELTS/ TOEFL. GRE in August. While the importance of the GRE in evaluation metrics may be diminishing over time, a strong GRE score can still significantly enhance an average profile. It is worth considering and preparing for the GRE to maximize your chances of standing out.",
            ...
            "IELTS/TOEFL in September. Unlike the GRE, IELTS/TOEFL is considered a necessary requirement to assess your English language proficiency. While some schools may waive this requirement if your undergraduate education was conducted in English, it is generally recommended to appear for either IELTS or TOEFL.",
        ...
        },
        {
          ...
          content: [
            ...
            "If you have really low CGPA it can be harder than usual for you.",
            ...
            "In the first tab, list the universities along with their attributes, including the university name, university website, city, state, ranking, department website, graduate coordinator email, minimum requirements for application, application fee, application portal link, the deadlines for application, Tuition fees and information about alumni currently studying there. This will help you gather comprehensive data and make informed decisions during your university selection process. Completing a comprehensive research task like this requires significant time and effort. It's important to consistently dedicate a portion of your day to making progress, even if it's just a little bit at a time.",
            "Fee Waivers: After listing down the prospective schools in your spreadsheet, the next step in your expedition is to reach out to the graduate coordinators for fee waivers. The application fees for graduate schools can vary significantly, ranging from $50 to as high as $250, which can be quite substantial. However, some schools offer fee waiver options, allowing you to apply for free. There are several ways to obtain fee waivers for your applications: Attending seminars and graduate open houses; Utilizing a waiver code, if available; Having the fee waived directly by a professor; Gaining approval from the admission committee by submitting proper documents that demonstrate financial hardship; Qualifying for location-based fee waivers; Applying before an early deadline; Contacting the financial aid departments for assistance.",
            "To explore the possibility of obtaining an application fee waiver and understand the process, it is recommended to email the graduate coordinator. It's important to note that while fee waivers can be beneficial in reducing costs, they often attract higher competition among applicants compared to schools without such waivers.",
            "On another tab of your spreadsheet, create a section where you can list the weather conditions (both in summer and winter), overall living costs, crime rate, living standards, availability of amenities, and information about industries and prominent companies in the cities and states that you are interested in.",
            "On the next tab of your spreadsheet, which is the most important one, you will create a list of potential professors to contact. Include: University, Professor Name, Research Field, Specific Topics, Email address, Professor's Website (if available), Openings in His/Her Lab, Known Seniors in His/Her Lab, Google Scholar Link, LinkedIn Profile Link (Send a connection request as well), Email Date, Reply, Follow-up Date, and Remarks.",
          ],
        },
        {
          ...
          content: [
            ...
            "Remember, it is important to craft unique and personalized emails that reflect your genuine interest in their work. Avoid using templates or copying someone else's email as it may come across as insincere or lacking effort. Take your time to research their work and craft a compelling email that highlights your passion for their research and your potential contributions to their lab. Seeking suggestions from peers can be helpful in refining your email and ensuring that it effectively communicates your intentions and interests.",
            "It's important to set realistic expectations when reaching out to professors for potential research opportunities. It's common to experience a low response rate, with around 10% or less of professors responding to your initial emails. Among those who respond, the positive response rate may be even lower, around 2-3%. It's crucial not to get disheartened by these statistics or compare your experience to others who may have received more responses. Instead of being discouraged, stay persistent and continue emailing professors who align with your research interests. Following up after a week is a reasonable timeframe, but limit your follow-ups to a maximum of two times. Keep your follow-up emails concise, polite, and respectful. While it's important to demonstrate your enthusiasm and interest, avoid being overly persistent or pushy. Celebrate every positive response you receive, even if they are few in number. It only takes one positive response to open doors to potential research opportunities.",
          ],
        },
        {
        ...
        },
        {
          ...
          content: [
            ...
            "To ensure your test scores reach the admission committee in a timely manner, send them as soon as possible from each test's individual portal. The processing and delivery can take some time, so don't delay. Throughout the application process, if you encounter any difficulties or have questions, don't hesitate to reach out to the graduate coordinator. Lastly, for payments, it's essential to have a dual currency card, especially for applicants living in Bangladesh.",
            "In addition, it is highly recommended not to wait until the application deadline. The earlier you submit your applications, the better it is for your chances of admission. Submitting your materials ahead of time demonstrates your proactive and organized approach.",
          ],
        },
        {
          title: "a. Department/Interest Switch",
          content: [
            ...
            "So what should you do? My suggestion is this: If a professor assures you, you can apply to a different department. However, if you want to experiment, play it safe. Don't limit your applications to just one department; keep some safe options open in your own field as well.",
          ],
        },
        {
          title: "b. My View on Central Application",
          content: [
        ...
        },
        {
          ...
          content: [
            ...
            "Don't Take It Personally: Remember that a rejection does not define your worth or abilities. Admissions decisions are often influenced by various factors beyond your control.",
            "Reflect and Learn: Take the opportunity to reflect on your application and identify areas for improvement. Consider seeking feedback from mentors, advisors, or professionals in your field.",
            "Keep Things in Perspective: Remember that one rejection does not determine your entire academic or professional journey. There are numerous opportunities and paths available to you.",
            "Explore Alternatives: If your dream universities have rejected you, explore other options that align with your academic and career aspirations.",
            "Seek Support: Reach out to friends, family, mentors, or support networks who can provide encouragement and perspective during this time.",
            "Stay Determined and Persevere: Remember that setbacks are a natural part of any journey. Use this experience as motivation to work harder, refine your goals, and strive for excellence.",
            "If you face rejections from all the schools you applied to, remember that it's not the end of the road. You can consider applying in the next admission cycle. The experience of being rejected by all three of my dream universities (UMD, UWisc, UWaterloo) was incredibly difficult for me. It felt like my world was crumbling, and I was left feeling shattered and defeated. However, thanks to the support of my loved ones, I was able to pick up the pieces and find the strength to move forward.",
        ...
        },
        {
          ...
          content: [
            ...
            "Understand Your I-20: Here's a tip: When the first university sends you their acceptance letter, obtain the I-20 from them and use it to apply for your visa, even if you don't intend to attend that university. While this approach may be slightly unconventional, it can save you from the strenuous process of chasing visa interview slots. Simply book your visa slot, inform the first university before the deadline (April 15th) that you won't be attending, and within a week before your visa interview, you can update your university choice in all relevant portals.",
        ...
        {
          title: "g. Necessary Health Reports & Vaccination",
          content: [
            "Before your arrival at any school, it is important to fulfill certain vaccination and testing requirements. While some universities may allow completion of these requirements after arrival, it is advisable to confirm this with your specific university. All tests and immunizations can be acquired at the least price from Bangabandhu Sheikh Mujib Medical University: BSMMU (PG Hospital), but it will be a lot a bit more challenging. Furthermore, Ibn Sina Diagnostic and Imaging Center, Japan Bangladesh Friendship Hospital, and icddr,b provide those vaccines and diagnostics.",
            "Footnote: https://docs.google.com/document/d/1iueuQMkViusw3rIFwd7Z4rotir97SDMfu3cTSKEo2F8/edit",
          ],
        },
        {
          title: "h. Necessary Health Checkups",
          content: [
        ...
        {
          title: "V. Visa Processing — a. Fill up DS 160 Form",
          content: [
            "Upon receiving your I-20, it is recommended to promptly begin filling out your DS-160 form for Non-immigrant Visa.",
            "CEAC Portal: https://ceac.state.gov/genniv/",
            "Step-by-step Guide: You have a total of 30 days to complete the application form from the moment you first open it. Therefore, you can take the necessary time to ensure accuracy and completeness. It's important to note that once you submit the form, you won't be able to make any further edits or corrections. In such cases, starting an entirely new application is required.",
        ...
        {
          title: "V. Visa Processing — b. Visa Photo",
          content: [
            ...
            "US Visa Photo Requirements apply.",
          ],
        },
        {
          title: "V. Visa Processing — c. Pay Visa Fee & SEVIS Fee",
          content: [
        ...
        {
          title: "V. Visa Processing — d. Schedule the Visa Interview",
          content: [
        ...
        {
          title: "V. Visa Processing — e. Appear in Your Visa Interview",
          content: [
            ...
            "To gain a better understanding and ease your concerns about the visa interview process, read the detailed visa interview experience and prospective questions. By going through these, you will obtain valuable insights and realize that it's all about approaching the interview with a relaxed mindset.",
        ...
        {
          title: "V. Visa Processing — f. Collect Your Passport",
          content: [
            ...
            "If you are unable to collect the visa in person, you can authorize someone to collect it on your behalf.",
            "Additionally, you can check the status of your visa by visiting the relevant portal or emailing your passport number to passportstatus@ustraveldocs.com.",
            "In the unlikely event that you haven't received a response from them for an extended period, such as a week or more, you can reach out via email for an update at support-bangladesh@ustraveldocs.com. Or, you can call: +88-09610202040 for queries.",
          ],
        },
        {
          title: "V. Visa Processing — g. Book Your Flight",
          content: [
            ...
            "Flight Time: Take into account the duration of the flight. Longer flights may be more expensive, but they could also offer more convenience and comfort.",
            "Baggage Allowance: It is essential to carefully review the information provided on your ticket and the airline's website regarding baggage allowance. Pay close attention to the dimensions and weight restrictions for both carry-on and checked baggage. Additionally, look for the list of items that are prohibited from being carried on board the aircraft.",
            "Number of Flights: Some itineraries may involve multiple flights or layovers. While these options may be cheaper, they can also result in longer travel times and potential inconveniences.",
            "Immigration Time: Depending on your destination, immigration procedures can vary in terms of efficiency and waiting times. Research the immigration process at the airports you'll be transiting through.",
            ...
            "While Google Flights can be a helpful tool for searching for flights, it's important to keep in mind that it can sometimes be misleading. The prices displayed on Google Flights may not always be accurate or up to date. It's always a good idea to double-check the prices directly on the airline's website or other reliable booking platforms before making any final decisions.",
          ],
        },
        {
          title: "VI. Shopping List",
          content: [
            "Medicine: https://docs.google.com/spreadsheets/d/1PxunNrNb3EL_wk39T3iYhnHG7MaDFSJx/edit?usp=sharing&ouid=104499056544666209164&rtpof=true&sd=true",
            "For Boys: https://www.facebook.com/groups/nextop.usa/permalink/1658824020883436/",
            "For Boys: https://www.facebook.com/groups/nextop.usa/permalink/4446467212119089/",
            "For Girls: https://www.facebook.com/groups/nextop.usa/permalink/2285490834883415/",
            "For Girls: https://www.facebook.com/groups/nextop.usa/permalink/3960848990680916/",
        ...
        {
          title: "X. Useful Links",
          content: [
            "FAQ From US Embassy: https://www.ustraveldocs.com/bd/bd-gen-faq.asp#qlistfandm",
            "Dream USA (Rangon): https://rangon.notion.site/Dream-USA-2ac6e5835eca402383675b6ee6839700",
            ...
            "Shimanto Bhoumik (GRE Experience): https://www.facebook.com/groups/nextop.usa/permalink/5820924071340056/",
            "Shimanto Bhoumik (TOEFL Experience): https://www.facebook.com/groups/nextop.usa/permalink/5899764033456059/",
            "Shimanto Bhoumik: https://www.facebook.com/groups/nextop.usa/permalink/6169521463146980/",
            ...
            "Ragib Hasan's Other posts",
            "Visa Application (NexTop USA): https://nextopusa.com/visa_application/",
            "The Timeline of Success (NexTop USA): https://nextopusa.com/timeline_of_success/",
            ...
            "After Arriving at the USA: https://www.facebook.com/groups/nextop.usa/posts/4179213342177812/",
